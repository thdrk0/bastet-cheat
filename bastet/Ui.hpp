...
namespace Bastet{
  ...
  public:
    ...
    void DropBlock(BlockType b, Well *w, const BlockType *nextBlock); //returns <score,lines>
    void AdjustAutoSpeed(int delta);
    int AutoDelayForLevel() const;
    
    void ChooseLevel();
    bool Play(BlockChooser *bc);
